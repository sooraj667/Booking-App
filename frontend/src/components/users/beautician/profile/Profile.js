        ...
        <div style={{"marginLeft":"320px","paddingTop":"20px"}}>
          <Typography variant="h6" component="h1" sx={{marginBottom:"1.9rem"}}>
            ...
            <div className="row  mt-3">
                ...
                <Typography variant="h6" component="h1"> {statedatas.value.beautdetails.email} </Typography>

            </div>

            <div className="row  mt-3">
                <Typography variant="h6" component="h1"> Phone : </Typography>
                <Typography variant="h6" component="h1"> {statedatas.value.beautdetails.phone} </Typography>
