...
const Otppage = () => {
    ...
    const handleSubmit=()=>{
        ...
        if (otpdatas.value.beautotpstatus==true){
            axiosInstance.post("beaut/confirmotp/",datas).then((response)=>{
                console.log(response.data);
                if(response.data.message=="Success"){
                    console.log(("NAVIGATE CHEYTH POKANAM"));
  ...
  return (
    ...
    <Paper
      ...
      sx={{
        ...
        backgroundImage:'url("https://images.unsplash.com/photo-1603899122634-f086ca5f5ddd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80")',
        objectFit: "cover",
